...
NAME=openapi-python-pytest-requests-artists

# Docker image default name
IMAGE=test/$(NAME)

# Mount localfile system
LOCAL_OPTS=-v $(shell pwd):/opt/openapi-python-pytest-requests-artists -e PYTHONPATH="/opt/openapi-python-pytest-requests-artists"
